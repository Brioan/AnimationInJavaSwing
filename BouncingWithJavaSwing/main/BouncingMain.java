 ...
 *  =============================================================
 *  Brian Lin
 *  BouncingMain.java : Extends JFrame and contains a panel where shapes move around on the screen. 
 *	Contains start and stop buttons that starts animation and stops animation respectively.
 *  ==============================================================
 */
...
public class BouncingMain extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon rectangleButtonIcon = createImageIcon("rectangle.png");
        ImageIcon squareButtonIcon = createImageIcon("square.png");
        ...
        ImageIcon fallButtonIcon = createImageIcon("fall.png");
        ImageIcon bounceButtonIcon = createImageIcon("bounce.png");
        ...
        xPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				int n = Integer.parseInt(xPosText.getText());
				panel.setCurrentXPos(n);
            }
        });
        ...
        yPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				int n = Integer.parseInt(yPosText.getText());
				panel.setCurrentYPos(n);
            }
        });
        ...
        heightText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				int n = Integer.parseInt(heightText.getText());
				panel.setCurrentHeight(n);


            }
        });
        //Set up the width TextField
        widthText = new JTextField("30");
        widthText.setToolTipText("Set Width");
        widthText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				int n = Integer.parseInt(widthText.getText());
				panel.setCurrentWidth(n);
        ...
        toolsPanel.add(Box.createRigidArea(new Dimension(30,0)));
        ...
        toolsPanel.add(Box.createRigidArea(new Dimension(30,0)));
        toolsPanel.add( new JLabel(" [Press Enter]  Set X: ", JLabel.RIGHT));
        toolsPanel.add(xPosText);
        toolsPanel.add(Box.createRigidArea(new Dimension(10,0)));
        toolsPanel.add(new JLabel(" Set Y: ", JLabel.RIGHT));
        ...
        slider.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent e) {
             ...
             if (!source.getValueIsAdjusting()) {
                 ...
                 tb.setTitle("Animation delay = " + String.valueOf(value) + " ms"); //adjust the tilted border to indicate the speed of the animation
                 panel.adjustSpeed(value); //set the speed
                 source.repaint();
             }
            }
        });
        TitledBorder title = BorderFactory.createTitledBorder("Animation delay = 30 ms");
    ...
    protected static ImageIcon createImageIcon(String filename) {
        java.net.URL imgURL = BouncingMain.class.getResource(filename);
